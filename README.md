# UC16 — Autonomy Rollout for Salesforce

Custom metadata version-bound Case policy gate returns review/hold; never automatically promotes autonomy.
